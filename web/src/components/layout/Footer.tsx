        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Delicious food delivered to your doorstep. Order from your favorite restaurants and enjoy fresh meals anytime.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/branches" className="text-gray-400 hover:text-orange-500 transition">
                  Locations
                </Link>
              </li>
              <li>
